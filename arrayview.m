...
%         by: ds1
%       date: 2019-11. set up for 2018/19 assignment
...
disp('==============================================')
fprintf('\tarrayview() program - 2019 assignment\n\n\n')
...
%       **your code should display a message in console
%       "data were 3D"**
%
%     - if the data are 4d, then take the mean across "time"
%       **your code should display a message in console
%       "data were 4D - taking the mean across time"**
%
